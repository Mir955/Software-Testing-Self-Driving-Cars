...
from beamng_utils import INPUT_SHAPE, batch_generator, IMAGE_HEIGHT, IMAGE_WIDTH, IMAGE_CHANNELS
...
def load_data(args):
    ...
    """
    global csv_path, X_train, X_valid, y_valid, y_train
    ...
    for track in tracks:
        ...
        try:
            ...
            csv_path = 'C:/Users/HP/Documents/Data_Log/Try_Demo2.csv'
            csv_folder = 'C:/Users/HP/Documents/Data_Log'
            ...
            csv_y = data_df['steering_value'].values
...
def train_model(model, args, X_train, X_valid, y_train, y_valid):
    ...
    checkpoint = ModelCheckpoint('trained_models/self-driving-car-{epoch:03d}.h5',
                                 monitor='val_loss',
                                 verbose=0,
